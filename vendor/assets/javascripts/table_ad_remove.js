function addRow(tableName) {
	...
	btn.setAttribute('onclick', "Boxy.ask('Düğüm türü hangisi olsun?', {'dal':'Normal', 'drug':'İlaç Seçim', 'exam':'Tahlil', 'bmap':'Vücut Haritası', 'immap':'Resim Haritası', 'diagnose':'Tedavi', 'report':'Rapor'}, function(r) { addNewNode('select" + nons + "', " + cid + ", r, " + id + "); }, {title:'Yeni Düğüm Ekleme'});");
